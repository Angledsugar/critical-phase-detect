"""π_0 (openpi) wrapped as a frozen base Policy. Paper §6.1.2.
...
_INSTALL_HINT = (
    "openpi is required for Pi0Policy. Install with `uv sync --extra vla` "
    "(see pyproject.toml [project.optional-dependencies] vla)."
)


class Pi0Policy:
    """Frozen π_0 base policy.

    Args:
        model_id: openpi config name (e.g. "pi0_libero").
